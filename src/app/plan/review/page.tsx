  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="rounded-3xl p-8" style={{ background: '#FAF8FF', border: '1px solid #E0D8F5' }}>
        <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-medium text-[#1A1030] mb-6">Signature</h3>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <div className="h-16 mb-2" style={{ borderBottom: '1px solid #C4B0E8' }} />
            <p className="text-xs text-[#8070A8]">Signature of principal</p>
          </div>
          <div>
            <div className="h-16 mb-2" style={{ borderBottom: '1px solid #C4B0E8' }} />
            <p className="text-xs text-[#8070A8]">Date</p>
          </div>
        </div>
      </div>
